...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Most popular US baby names between 2010 and 2020',
...
tbl_names_by_letter |> 
  ...
  labs(
    title = 'Distribution of birth by first letter for 2020',
    subtitle = 'Most populat female letter is A, male letter is J',
    caption = 'Source: US baby names',
    x = 'First letter',
    y = 'Percentage births'
  ) +
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = glue::glue("Most common trends in {my_letter} below"),
      caption = "Source: US Baby names",
      x = "Year",
      y = 'Percentage Births'
    ) +
